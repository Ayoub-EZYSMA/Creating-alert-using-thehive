...
# Installation guide of Shuffle platform
...
# Installation guide of thehive
1. Make sure you have [Docker](https://docs.docker.com/get-docker/) and [docker-compose](https://docs.docker.com/compose/install/) installed.
2. Download Shuffle
```bash
git clone https://github.com/TheHive-Project/Docker-Templates/tree/main/docker/thehive3
cd thehive3
```
